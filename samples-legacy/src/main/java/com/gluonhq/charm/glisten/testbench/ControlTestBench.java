...
public class ControlTestBench extends MobileApplication {
        ...
        addViewFactory(HOME_VIEW, () -> new View() {
            {
                ...
                setOnShowing(e -> {
                    ...
                    appBar.setNavIcon(MaterialDesignIcon.MENU.button(f -> getDrawer().open()));
...
//        });
        ...
        addViewFactory(SPLASH_VIEW, () -> {
            ...
            splashView.setOnShown(e -> {
                // it is developer's responsability to make it work
...
//        });
    ...
    public void postInit(Scene scene) {
        ...
        // build parts of the UI that will be display later on
        Header header = new Header("GluonHQ",
                "support@gluonhq.com",
                new Avatar(21)); //, new Image(Avatar.class.getResourceAsStream("/com/gluonhq/charm/glisten/G_Blue_500_58x58.png"))));
        getDrawer().setHeader(header);
        setTitle("Glisten TestBench");
        ...
        getDrawer().getItems().setAll(createItemsFrom(views));
    }
        ...
        addViewFactory(viewId, () -> {
            View view = new View(root) {
...

                {
                    ...
                    navigationButton.setOnAction(e -> getDrawer().open());
                    mnDarkTheme = new MenuItem("Dark Theme");
                    mnDarkTheme.setOnAction(e -> Theme.DARK.assignTo(getAppBar().getScene()));
                    mnLightTheme = new MenuItem("Light Theme");
                    mnLightTheme.setOnAction(e -> Theme.LIGHT.assignTo(getAppBar().getScene()));
                }
