    ...
    public void initialize() {
        try {
            StorageService storageService = StorageService.create()
                    .orElseThrow(() -> new IllegalStateException("Charm Attach Storage Service is not available. Please make sure that the 'storage' plugin is configured in the Gluon Mobile project."));
